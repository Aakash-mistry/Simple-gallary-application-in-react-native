...
import {Svg, Styles, Path, SvgProps} from 'react-native-svg';

const ImageIcon: React.FC<SvgProps> = ({height, width, color}) => {
  return (
    <Svg height={height} width={width} fill={color}>
      <Path
        d="M464,128h-16v-16c0-26.51-21.49-48-48-48h-16V48c0-26.51-21.49-48-48-48H48C21.49,0,0,21.49,0,48v288
